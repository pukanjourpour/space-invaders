...
class ControllerLevel:
    ...
    def generate_level(level: int) -> Tuple[List[Actor], List[Obstacle]]:
        ...
        if level == 1:
            ...
            enemy: EnemyStage1 = EnemyStage1(Settings.SCREEN_WIDTH/2 - 25, 30, 50, 50, Settings.PLAYER_SPEED, 1)
        actors: List[Actor] = [player, enemy]
        obstacles: List[Obstacle] = [Obstacle(Settings.SCREEN_WIDTH/2 - 25, Settings.SCREEN_HEIGHT - 150, 50, 50)]
